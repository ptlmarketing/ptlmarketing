...
function ServiceCardOnHome({ data }) {
  ...
  return (
    <div className={` ${heading=="Meta & Google Ads"?"md:mt-42":""} ${heading=="SEO Optimization"?"md:mt-20":""} ${heading=="Brand Strategy"?"md:mt-20":""} ${heading=="Influencer Marketing"?"md:mt-42":""}`}>
